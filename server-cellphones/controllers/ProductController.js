...
export const AddProduct = expressAsyncHandler(async (req, res) => {
  ...
  const product = new ProductModel({
    ...
    sanhang: req.body.sanhang,
    nhucausd: req.body.nhucausd,
    loaidt: req.body.loaidt,
...
export const UpdateProduct = expressAsyncHandler(async (req, res) => {
  ...
  if (product) {
    ...
    // dien thoai
    product.dienthoai = req.body.dienthoai;
    product.sanhang = req.body.sanhang;
    product.nhucausd = req.body.nhucausd;
    product.loaidt = req.body.loaidt;
    product.bonho = req.body.bonho;
    product.dungluong = req.body.dungluong;
    product.tinhnang = req.body.tinhnang;
    product.camera = req.body.camera;
    product.tansoquet = req.body.tansoquet;

    //laptop
    product.laptop = req.body.laptop;
    product.sanh = req.body.sanh;
    product.ssd = req.body.ssd;
    product.ram = req.body.ram;
    product.cpu = req.body.cpu;
    product.kichthuoc = req.body.kichthuoc;
    product.pgiai = req.body.pgiai;
...
export const SearchProduct = expressAsyncHandler(async (req, res) => {
    ...
    product.length > 0 ? res.send(product) : res.send({message: ' Khong co san pham ban tim kiem'})
})
